...
void loop() {
    if (Slave.available()) {
      ...
      Serial.println(ID);
      Serial.print("So I should turn: ");
      Serial.println(msgString[ID]);
      //Serial.print("my data x 10 = : ");
      //Serial.println(int(msgString[ID]-'0')*10);
      stepper.rotate(360 * int(msgString[ID]-'0'));
    }
}
